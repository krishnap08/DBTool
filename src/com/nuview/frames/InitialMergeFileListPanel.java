...
public class InitialMergeFileListPanel extends JPanel {
	...
	private void initComponents() {
		...
		btnExecuteAutoMerge = new JButton(
				"<html><b>Execute Automerge</b></html>");
		...
		lblTableName2 = new JLabel(
				"<html><h3>Standard Old File List</h3></html>");
		lblTableName3 = new JLabel(
				"<html><h3>Standard New File List</h3></html>");
	...
	public void getFileList() {
		...
		customOldFileTable = new JTable(fileUtil.toTableModel(fileUtil
				.getFileMap("custom_old")));
		...
		stdOldFileTable = new JTable(fileUtil.toTableModel(fileUtil
				.getFileMap("standard_old")));
		...
		stdNewFileTable = new JTable(fileUtil.toTableModel(fileUtil
				.getFileMap("standard_new")));
	...
	private JScrollPane customOldScrollpane, stdOldScrollpane,
			stdNewScrollpane;
